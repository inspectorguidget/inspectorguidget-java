...
import fr.inria.inspectorguidget.filter.BasicFilter;
import fr.inria.inspectorguidget.filter.ClassMethodCallFilter;
import fr.inria.inspectorguidget.filter.ConditionalFilter;
import fr.inria.inspectorguidget.filter.FindElementFilter;
import fr.inria.inspectorguidget.filter.FindElementsFilter;
import fr.inria.inspectorguidget.filter.LocalVariableAccessFilter;
import fr.inria.inspectorguidget.filter.MyVariableAccessFilter;
import fr.inria.inspectorguidget.helper.LinePositionFilter;
import fr.inria.inspectorguidget.helper.SpoonHelper;
import fr.inria.inspectorguidget.helper.Tuple;
